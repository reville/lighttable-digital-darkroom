...
export function createAppState(gradeDefaults, opticsDefaults) {
  return {
    ...
    healToolMode: 'remove', overlayAltKey: false, overlayHoverPoint: null, overlayHoverClientPoint: null, localPinsVisible: true,
    ...
    healShape: 'spot', healFill: 'patch', dustBrush: { sensitivity: 0.5, size: 0.004 },
    dustDetection: null, dustDetectTimer: 0, dustDetectGeneration: 0,
    curvePick: null, samplerMode: false, samplers: new Map(),
    rootFolder: '', folders: [], folderIds: {}, sources: [], activeFolder: '',
    ...
    libraryLoaded: false, pendingActiveCollection: null,
    activeCollection: '',
