...
FILES = ('app/main.swift', 'app/DiagnosticReports.swift', 'windows-shell/src/main.rs', 'windows-shell/src/linux.rs', 'windows-shell/src/windows_update.rs', 'windows-shell/src/localization.rs', 'app/Info.plist')
